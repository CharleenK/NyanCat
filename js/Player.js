...
class Player {
  ...
  constructor(root) {
    ...
    this.domElement.style.height = "55px";
    this.domElement.style.width = "51px";
    this.domElement.src = "images/babyTurtle-C.png";
  ...
  moveRight() {
    console.log(`turtle:${this.x + PLAYER_WIDTH}, game width:${GAME_WIDTH}`);
